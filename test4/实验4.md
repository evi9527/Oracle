...
下面是创建用户new_dk
```
CREATE USER NEW_DK IDENTIFIED BY 123
DEFAULT TABLESPACE "USERS"
TEMPORARY TABLESPACE "TEMP";

-- QUOTAS
ALTER USER NEW_DK QUOTA UNLIMITED ON USERS;
ALTER USER NEW_DK QUOTA UNLIMITED ON USERS02;
ALTER USER NEW_DK ACCOUNT UNLOCK;

-- ROLES
GRANT "CONNECT" TO NEW_DK WITH ADMIN OPTION;
GRANT "RESOURCE" TO NEW_DK WITH ADMIN OPTION;
ALTER USER NEW_DK DEFAULT ROLE "CONNECT","RESOURCE";

-- SYSTEM PRIVILEGES
GRANT CREATE VIEW TO NEW_DK WITH ADMIN OPTION;
```
...
![r3](https://github.com/evi9527/Oracle/blob/master/test4/pic/reslut1.png)
![r3](https://github.com/evi9527/Oracle/blob/master/test4/pic/reslut2.png)
![r3](https://github.com/evi9527/Oracle/blob/master/test4/pic/reslut3.png)
![r3](https://github.com/evi9527/Oracle/blob/master/test4/pic/reslut4.png)

[sql运行代码]https://github.com/evi9527/Oracle/blob/master/test4/sql.txt
...
![r3](https://github.com/evi9527/Oracle/blob/master/test4/pic/订单表查询结果.png)
![r3](https://github.com/evi9527/Oracle/blob/master/test4/pic/详单表查询结果.png)
![r3](https://github.com/evi9527/Oracle/blob/master/test4/pic/验证查询结果.png)

可见详单表最后付款与订单表里的一样，是没有问题的。

接下来修改详单表里的一些数据，再看计算结果的正确与否：

![r3](https://github.com/evi9527/Oracle/blob/master/test4/pic/订单表查询结果改.png)
![r3](https://github.com/evi9527/Oracle/blob/master/test4/pic/详单表查询结果改.png)
![r3](https://github.com/evi9527/Oracle/blob/master/test4/pic/验证查询结果改.png)

可以发现修改后一样是符合的，证明数据插入与生成没有问题。
